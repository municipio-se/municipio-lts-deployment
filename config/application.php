...
// Disable the ftp layer to work around 'Undefined constant "Kirki\Module\Webfonts\FS_CHMOD_DIR' error
...
Config::define(
  "TWO_FACTOR_ENFORCE_EDITOR",
  env("TWO_FACTOR_ENFORCE_EDITOR") ?? false,
);
Config::define("MATOMO_URL", env("MATOMO_URL"));
Config::define("MATOMO_CONTAINER_ID", env("MATOMO_CONTAINER_ID"));
